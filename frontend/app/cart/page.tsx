...
export default function CartPage() {
  const [cartItems, setCartItems] = useState([
    { id: 1, name: 'Custom T-Shirt', price: 450.00, quantity: 2, image: '/tshirt.png', inStock: true },
    { id: 2, name: 'Custom Shirt', price: 750.00, quantity: 1, image: '/shirt.png', inStock: true },
  ])
