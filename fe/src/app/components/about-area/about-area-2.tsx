					...
					<div className="row justify-content-center align-items-center">
						...
						<div className="col-xl-6 col-lg-6 col-md-10">
							<div className="section__title text-start mb-30">
								<h3 className="title">
									The Journey of The <br /> NFT Sites
								</h3>
							</div>
							<div className="about__content-two">
								<p>
									Gorem npsum dolor sit amet consectetur
									adipiscing elit. Duis elementum sollici
									tudin augue euismod. Nulla ullamcorper nunc.
									Morbi pharetra mi tellus mollis tincidunt
									massa venenatis. Etiam lacinia
									ipsumultrices.
								</p>
							</div>
