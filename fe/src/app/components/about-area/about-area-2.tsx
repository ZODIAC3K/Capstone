					...
					<div className="row justify-content-center align-items-center">
						...
						<div className="col-xl-6 col-lg-6 col-md-10">
							...
							<div className="about__content-two">
								<p>
									Unleash your creativity and design your own
									clothing line, organizing your masterpieces
									into catalogs like curated playlists. Earn
									royalties on every sale, with up to 40% of
									the profits, while we take care of the
									platform. Your personalized dashboard lets
									you effortlessly manage your designs, sales,
									and earnings—making it easy to build your
									fashion empire.
								</p>
							</div>
