				...
				<div className="row justify-content-center">
					<div className="col-lg-6 col-md-10">
						<div className="contact__content">
							...
							<h2 className="title">
								CONTACT US AND UNLEASH YOUR CREATIVITY
							</h2>
							<p>
								Turn your ideas into reality and redefine
								fashion your way. Whether you're designing your
								own line or discovering unique styles, we're
