...
export default function OrderPage() {
    ...
    const getTransactionId = (order: Order) => {
        if (isObjectReference(order.transaction_id)) {
            return order.transaction_id._id
        }
    ...
    if (orders.length === 0) {
        return (
            <>
                <Header />
                <div className='bg-dark text-white min-vh-100 d-flex justify-content-center align-items-center pt-5 mt-5'>
                    <div className='text-center'>
                        <div className='mb-4'>
                    ...
                    {filteredOrders.length > 0 && (
                        <div className='d-flex justify-content-between align-items-center mt-3'>
                            <div className='text-white-50'>
                                Showing {indexOfFirstOrder + 1} to {Math.min(indexOfLastOrder, filteredOrders.length)}{' '}
                                ...
                                <div className='modal-content bg-dark text-white border-secondary'>
                                    ...
                                    <div className='modal-body'>
                                        ...
                                        <div className='alert alert-warning'>
                                            <small>
                                                Cancelling will immediately stop this order from being processed. If
                                                payment has been made, it may take 5-7 business days for a refund to be
                                                processed.
                                            </small>
                                        </div>
                                    </div>
                            ...
                            <div className='modal-dialog modal-dialog-centered'>
                                <div className='modal-content bg-dark text-white border-secondary'>
                                    ...
                                    <div className='modal-body'>
                                        ...
                                        <div className='alert alert-warning'>
                                            <small>
                                                Once approved, refunds typically take 5-7 business days to be credited
