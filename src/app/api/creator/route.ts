...
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            ...
            // Get images
            const profileImage = formData.get('creatorProfileImage') as File | null
...
export async function PATCH(request: NextRequest) {
    try {
        ...
        try {
            ...
            const existingCreator = await CreatorModel.findOne({ userId: authUser.userId }, null, { session })
            ...
            if (profileImage) {
                ...
                if (existingCreator.creatorProfilePicture) {
                    await ImageModel.findByIdAndDelete(existingCreator.creatorProfilePicture, { session })
                }
            ...
            if (coverImage) {
                ...
                if (existingCreator.creatorCoverImage) {
                    await ImageModel.findByIdAndDelete(existingCreator.creatorCoverImage, { session })
                }
            ...
            if (profileImageId) updateFields.creatorProfilePicture = profileImageId
