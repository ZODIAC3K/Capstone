...
const Header = ({ style_2 = false }: { style_2?: boolean }) => {
    ...
    useEffect(() => {
        ...
        const intervalId = setInterval(fetchCartCount, 60000) // Refresh every minute
                                                ...
                                                {isLoggedIn && userData ? (
                                                    <div className='user-dropdown-container'>
                                                        ...
                                                        >
                                                            ...
                                                            <i className='flaticon-user me-2'></i> {userData.name}
                                                        </a>

                                                        {showDropdown && (
                                                            <div className='custom-dropdown'>
                                                                <Link href='/creator-profile' className='dropdown-item'>
                                                    ...
                                                    >
                                                        <SvgIconCom icon={shape} id='svg-2' />
                                                        <i className='flaticon-edit me-2'></i> Login
                                                    </Link>
                                                )}
                                            </li>
                                            <li
